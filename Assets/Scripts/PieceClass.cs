...
/// <summary>
/// Represents a single puzzle piece with drag and drop functionality.
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (piece != null)
        {
            ...
            if (slot != null && slot.GetId() == dragPiece.GetPiecePreviousId())
            {
                ...
                // Use animation for piece placement if available
                if (animationController != null)
                {
                    animationController.AnimatePiecePlacement(piece.transform, slot.transform, () =>
                    {
